    ...
    <PublicLayout>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-20">
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 animate-in slide-in-from-bottom-10 duration-700">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
                <Link href="/landlord">
                  <Button size="lg" className="w-full sm:w-auto h-11 sm:h-14 px-6 sm:px-8 text-sm sm:text-base shadow-xl shadow-primary/20 hover:shadow-2xl hover:shadow-primary/30 transition-all rounded-full">
                    Start Free Trial <ArrowRight className="w-3 sm:w-4 h-3 sm:h-4 ml-2" />
                  </Button>
                </Link>
                <Link href="/tenant">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
            <div className="p-6 sm:p-8 rounded-lg sm:rounded-2xl bg-gray-50 border border-gray-100 hover:shadow-lg transition-all group">
              <div className="w-10 sm:w-12 h-10 sm:h-12 bg-blue-100 text-blue-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="p-6 sm:p-8 rounded-lg sm:rounded-2xl bg-gray-50 border border-gray-100 hover:shadow-lg transition-all group">
              <div className="w-10 sm:w-12 h-10 sm:h-12 bg-green-100 text-green-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="p-6 sm:p-8 rounded-lg sm:rounded-2xl bg-gray-50 border border-gray-100 hover:shadow-lg transition-all group sm:col-span-2 lg:col-span-1">
              <div className="w-10 sm:w-12 h-10 sm:h-12 bg-purple-100 text-purple-600 rounded-lg sm:rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
      ...
      <section className="py-12 sm:py-24 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-heading font-bold mb-4 sm:mb-6">Ready to upgrade your workflow?</h2>
          <p className="text-blue-200 text-sm sm:text-base lg:text-xl mb-6 sm:mb-10 max-w-2xl mx-auto">Join thousands of landlords who trust IKON to manage their properties.</p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <Link href="/landlord">
              <Button size="lg" variant="secondary" className="w-full sm:w-auto h-11 sm:h-14 px-6 sm:px-8 text-sm sm:text-base rounded-full font-bold">
                Get Started for Free
              </Button>
            </Link>
            <Link href="/admin">
              <Button size="lg" variant="outline" className="w-full sm:w-auto h-11 sm:h-14 px-6 sm:px-8 text-sm sm:text-base rounded-full border-white/20 text-white hover:bg-white/10 hover:text-white">
                Contact Sales
              </Button>
            </Link>
          </div>
